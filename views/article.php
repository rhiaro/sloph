<article class="h-entry" typeof="as:Article" about="">
  ...
  <?if(get_value($resource, 'as:updated')):?>
    ...
    <p><em>Last modified: </em><time class="dt-updated"><a property="as:updated" href="<?=str_replace("https://rhiaro.co.uk", "", get_uri($resource))?>"><?=$date->format("D jS \o\\f F Y \a\\t g:ia (e)")?></a></time></p>
  <?endif?>
